...
a_prioris = {
    ...
    'O. arenosella_senc': [dict(etapa='adulto',
                           ...
                           dict(etapa='adulto',
                                ...
                                org_inter='Palma de coco', etp_inter='planta',
                                # Unidades: 100m**2 d -1
                                rango=((1823-100*1.96)/(53.1+10.64*1.96)*1e-9, (1823-100*1.96)/(53.1-10.64*1.96)*1e-9),
                                certidumbre=0.80),
                           dict(etapa='adulto',
                                ubic_parám=['Depredación', 'Ecuación', 'Kovai', 'b'],
                                org_inter='Palma de coco', etp_inter='planta',
                                rango=(((1823-100*1.96)/(53.1+10.64*1.96)*1e-9)**2,
                                       ((1823-100*1.96)/(53.1-10.64*1.96)*1e-9)**2),
                                certidumbre=0.80)  # Para hacer
                           ],
    ...
    'Araña': [dict(etapa='adulto',
              ...
              dict(etapa='adulto',
                   ...
                   certidumbre=0.80),  # para hacer
              dict(etapa='adulto',
                   ubic_parám=['Error', 'Dist', 'Normal', 'sigma'],
                   rango=(0, 0.01),
                   certidumbre=1),
              ],
    ...
    'O. arenosella': [
        ...
        dict(etapa='juvenil_1',
             ubic_parám=['Depredación', 'Ecuación', 'Kovai', 'a'],
             rango=((1823-100*1.96)/(53.1+10.64*1.96)*1e-9*.2, (1823-100*1.96)/(53.1-10.64*1.96)*1e-9*.2),
             certidumbre=0.80,
             ),
        dict(etapa='juvenil_1',
             ubic_parám=['Depredación', 'Ecuación', 'Kovai', 'b'],
             rango=(((1823-100*1.96)/(53.1+10.64*1.96)*.2*1e-9)**2, ((1823-100*1.96)/(53.1-10.64*1.96)*.2*1e-9)**2),
             certidumbre=0.80,
             ),
        dict(etapa='juvenil_1',
             ubic_parám=['Muertes', 'Ecuación', 'Constante', 'q'],
        ...
        dict(etapa='adulto',
             ...
             certidumbre=0.80),
        dict(etapa='adulto',
             ubic_parám=['Reproducción', 'Prob', 'Normal', 'n'],
             rango=(59/2, 252/2),
             certidumbre=0.80),
        dict(etapa='adulto',
             ubic_parám=['Reproducción', 'Prob', 'Normal', 'mu'],
             rango=(2.5, 4.5),
             certidumbre=0.80),
        dict(etapa='adulto',
             ubic_parám=['Reproducción', 'Prob', 'Normal', 'sigma'],
             rango=(1, 2),
             certidumbre=0.80),
        dict(etapa='adulto',
             ubic_parám=['Error', 'Dist', 'Normal', 'sigma'],
