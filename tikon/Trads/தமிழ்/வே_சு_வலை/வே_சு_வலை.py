...
class வேளாண்_சுழ்_வலை(RedAE.Red):
    ...
    def நடக்க(símismo, சோதனை, படி=1, கடைசியான_நேரம்=None, பண்பளவு_திரும்ப_எண்=100,
        ...
        super().simular(exper=சோதனை, paso=படி, tiempo_final=கடைசியான_நேரம்,
    ...
    def செல்லுபடியாக்கு(símismo, சோதனை, அளவிடுகள்=None, படி=1,
