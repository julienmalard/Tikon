...
a_prioris = {
    "O. arenosella_senc": [
        dict(
            ...
            prm="r",
            apriori=APrioriDens(
                ((2.721 - 0.7539) / 2 * 1.96, (2.721 + 0.7539) / 2 * 1.96), 0.80
            ),
        ),
        dict(
            etapa="adulto",
            ...
            etp_inter="planta",
            apriori=APrioriDens(
                (1 / (1823 + 100 * 1.96), 1 / (1823 - 100 * 1.96)), 0.80
            ),
        ),
        dict(
            etapa="adulto",
    ...
    "Parasitoide_senc": [
        dict(
            ...
            apriori=APrioriDens((0.402 * 0.8, (4.35 + 2.214 / 2) * 0.8), 0.80),
        ),
        dict(
            etapa="adulto",
            categ="Crecimiento",
    ...
    "O. arenosella": [
        ...
        dict(
            ...
            apriori=APrioriDens(
                (
                    (1823 - 100 * 1.96) / (53.1 + 10.64 * 1.96) * 1e-9 * 0.2,
                    (1823 - 100 * 1.96) / (53.1 - 10.64 * 1.96) * 1e-9 * 0.2,
                ),
                0.80,
            ),
        ...
        dict(
            ...
            apriori=APrioriDens(
                (
                    ((1823 - 100 * 1.96) / (53.1 + 10.64 * 1.96) * 0.2 * 1e-9) ** 2,
                    ((1823 - 100 * 1.96) / (53.1 - 10.64 * 1.96) * 0.2 * 1e-9) ** 2,
                ),
                0.80,
            ),
    ...
    "Parasitoide larvas": [
        ...
        dict(
            ...
            apriori=APrioriDens((0.005, 0.01), 0.80),
        ),
        dict(
            etapa="adulto",
            categ="Depredación",
    ...
    "Parasitoide pupa": [
        ...
        dict(
            ...
            ec="Kovai",
            prm="a",
            apriori=APrioriDens((0.08, 0.1), 0.80),
        ),  # ratio M:H = 2.8:1  (0.5 / 3.8, 1 / 3.8)
        dict(
            etapa="adulto",
            categ="Depredación",
            subcateg="Ecuación",
