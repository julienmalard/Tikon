...
a_prioris = {
    ...
    'O. arenosella': [
        ...
        dict(etapa='juvenil_1',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.07 / 7, 0.5 / 5), 0.8)  # por día
             ),
        dict(etapa='juvenil_1',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
        ...
        dict(etapa='juvenil_2',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.07 / 8, 0.4 / 6), 0.8),
             ),
        dict(etapa='juvenil_2',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
        ...
        dict(etapa='juvenil_4',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.07 / 6, 0.5 / 4), 0.8)),
        dict(etapa='juvenil_4',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
        ...
        dict(etapa='juvenil_5',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.07 / 11, 0.8 / 9), 0.8)),
        dict(etapa='juvenil_5',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
        ...
        dict(etapa='pupa',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.07 / 9, 0.6 / 7), 0.8)),
        dict(etapa='adulto',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
    ...
    'Parasitoide larvas': [
        ...
        dict(etapa='adulto',
             categ='Depredación', subcateg='Ecuación', ec='Kovai', prm='b',
             apriori=APrioriDens((0 * 1.0e6, 1.0e8), 0.80)),
        dict(etapa='adulto',
             categ='Estoc', subcateg='Dist', ec='Normal', prm='sigma',
             apriori=APrioriDens((0, 0.01), 1)),
        dict(etapa='pupa',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
             apriori=APrioriDens((0, 14), 0.80)),
        dict(etapa='pupa',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='sigma',
             apriori=APrioriDens((.5, .6), 0.80)),
        dict(etapa='pupa',
             categ='Muertes', subcateg='Ecuación', ec='Constante', prm='q',
             apriori=APrioriDens((0.01, 0.5), 0.8)),
        dict(etapa='pupa',
             categ='Estoc', subcateg='Dist', ec='Normal', prm='sigma',
             apriori=APrioriDens((0, 0.01), 1)),
        dict(etapa='juvenil',
    ...
    'Parasitoide pupa': [
        ...
        dict(etapa='juvenil',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
             apriori=APrioriDens((17, 19), 0.80)),
        dict(etapa='juvenil',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='sigma',
             apriori=APrioriDens((.5, .6), 0.80)),
        dict(etapa='juvenil',
