...
a_prioris = {
    ...
    'Parasitoide larvas': [
        ...
        dict(etapa='adulto',
             ...
             apriori=APrioriDens((.005, 0.01), 0.80)),  # .05 ?
        dict(etapa='adulto',
             categ='Depredación', subcateg='Ecuación', ec='Kovai', prm='a',
             índs=['O. arenosella', 'O. arenosella juvenil_5'],
             apriori=APrioriDens((0.8, 1.2), 0.80)),
        dict(etapa='adulto',
             categ='Depredación', subcateg='Ecuación', ec='Kovai', prm='b',
    ...
    'Parasitoide pupa': [
        ...
        dict(etapa='adulto',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='mu',
             apriori=APrioriDens((30, 35), 0.80)),
        dict(etapa='adulto',
             categ='Transiciones', subcateg='Prob', ec='Normal', prm='sigma',
             apriori=APrioriDens((2, 5), 0.80)),
        dict(etapa='adulto',
             categ='Depredación', subcateg='Ecuación', ec='Kovai', prm='a',
             apriori=APrioriDens((0.07, 0.1), 0.80)),  # ratio M:H = 2.8:1  (0.5 / 3.8, 1 / 3.8)
        dict(etapa='adulto',
             categ='Depredación', subcateg='Ecuación', ec='Kovai', prm='b',
             apriori=APrioriDens((1.0e5, 2.0e5), 0.80)),
        dict(etapa='adulto',
             categ='Estoc', subcateg='Dist', ec='Normal', prm='sigma',
             apriori=APrioriDens((0, 0.01), 1)),
        dict(etapa='juvenil',
