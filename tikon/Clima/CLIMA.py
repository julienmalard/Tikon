...
from tikon.Clima import eval_estaciones as eval_estaciones
from tikon.Clima import generarmeteo as generarmeteo
from tikon.Clima import krigear as krigear
