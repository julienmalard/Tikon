...
Líms_Con_None = tuple[
    Union[Tipo_Valor_Numérico, None], Union[Tipo_Valor_Numérico, None]
]
...
dists: dict[str, DicEspecDistScipy] = {
    ...
    "Arcsen": {"scipy": estad.arcsine, "paráms": ["loc", "scale"], "límites": (0, 1)},
    "Beta": {
        "scipy": estad.beta,
    ...
    "Chi": {"scipy": estad.chi, "paráms": ["df", "loc", "scale"], "límites": (0, None)},
    "Chi2": {
        "scipy": estad.chi2,
        "paráms": ["df", "loc", "scale"],
        "límites": (0, None),
    ...
    "CauchyDoblada": {
        "scipy": estad.foldcauchy,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "NormalDoblada": {
        "scipy": estad.foldnorm,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "LogísticaGeneral": {
        "scipy": estad.genlogistic,
        "paráms": ["c", "loc", "scale"],
        "límites": (None, None),
    },
    "NormalGeneral": {
    ...
    "ParetoGeneral": {
        "scipy": estad.genpareto,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "ExtremaGeneral": {
        "scipy": estad.genextreme,
        "paráms": ["c", "loc", "scale"],
        "límites": (None, None),
    },
    "Gamma": {
    ...
    "GumbelDerecho": {
        "scipy": estad.gumbel_r,
        "paráms": ["loc", "scale"],
        "límites": (None, None),
    },
    "GumbelIzquierda": {
        "scipy": estad.gumbel_l,
        "paráms": ["loc", "scale"],
        "límites": (None, None),
    },
    "MitadCauchy": {
        "scipy": estad.halfcauchy,
        "paráms": ["loc", "scale"],
        "límites": (0, None),
    },
    "MitadLogística": {
        "scipy": estad.halflogistic,
        "paráms": ["loc", "scale"],
        "límites": (0, None),
    },
    "MitadNormal": {
        "scipy": estad.halfnorm,
        "paráms": ["loc", "scale"],
        "límites": (0, None),
    },
    "HyperSecante": {
        "scipy": estad.hypsecant,
        "paráms": ["loc", "scale"],
        "límites": (None, None),
    },
    "GammaInversa": {
        "scipy": estad.invgamma,
        "paráms": ["a", "loc", "scale"],
        "límites": (0, None),
    },
    "GaussInversa": {
        "scipy": estad.invgauss,
        "paráms": ["mu", "loc", "scale"],
        "límites": (0, None),
    },
    "WeibullInversa": {
        "scipy": estad.invweibull,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "Laplace": {
    ...
    "Levy": {"scipy": estad.levy, "paráms": ["loc", "scale"], "límites": (0, None)},
    "Logística": {
        "scipy": estad.logistic,
        "paráms": ["loc", "scale"],
        "límites": (None, None),
    },
    "LogGamma": {
        "scipy": estad.loggamma,
        "paráms": ["c", "loc", "scale"],
        "límites": (None, None),
    },
    "LogLaplace": {
        "scipy": estad.loglaplace,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "LogNormal": {
    ...
    "Pearson3": {
        "scipy": estad.pearson3,
        "paráms": ["skew", "loc", "scale"],
        "límites": (None, None),
    },
    "Potencial": {
        "scipy": estad.powerlaw,
        "paráms": ["a", "loc", "scale"],
        "límites": (0, 1),
    },
    "Rayleigh": {
        "scipy": estad.rayleigh,
        "paráms": ["loc", "scale"],
        "límites": (0, None),
    },
    "Rice": {
    ...
    "NormalSesgada": {
        "scipy": estad.skewnorm,
        "paráms": ["a", "loc", "scale"],
        "límites": (None, None),
    },
    "T": {"scipy": estad.t, "paráms": ["df", "loc", "scale"], "límites": (None, None)},
    "Triang": {
        "scipy": estad.triang,
        "paráms": ["c", "loc", "scale"],
    ...
    "Wald": {"scipy": estad.wald, "paráms": ["loc", "scale"], "límites": (0, None)},
    "Weibull": {
        "scipy": estad.weibull_min,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, None),
    },
    "WeibullMáximo": {
        "scipy": estad.weibull_max,
        "paráms": ["c", "loc", "scale"],
        "límites": (None, 0),
    },
    "CauchyEnvuelto": {
        "scipy": estad.wrapcauchy,
        "paráms": ["c", "loc", "scale"],
        "límites": (0, 2 * pi),
    },
}
...
def líms_dist(dist: Union[str, rv_continuous_frozen]) -> Líms_Numéricas:
    if isinstance(dist, str):
        ...
        return líms[0] + ubic, (líms[1] - líms[0]) * escala + (
            (líms[0] + ubic) if líms[0] > -np.inf else 0
        )


def obt_prms_obj_scipy(
    dist: rv_continuous_frozen,
) -> tuple[tuple, Tipo_Valor_Numérico, Tipo_Valor_Numérico]:
