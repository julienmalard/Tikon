...
class ObsRAE(Obs):
    ...
    def de_cuadro(
        ...
        **argsll,
        ...
        corresp = {
            ll: tuple(v) if not isinstance(v, Etapa) else v for ll, v in corresp.items()
        }
        return super().de_cuadro(
            datos_pd,
            corresp=corresp,
            eje_principal=EJE_ETAPA,
            parc=parcela,
            tiempo=tiempo,
            coords=coords,
            factor=factor,
...
class ObsMov(ObsRAE):
    ...
    @classmethod
    def de_cuadro(
        cls, datos_pd, corresp, tiempo=None, parcela=None, dest=None, factor=1, **argsll
    ):
        coords = {
...
class ObsImigr(ObsTrans):
    ...
    @classmethod
    def de_cuadro(
        cls, datos_pd, corresp, tiempo=None, parcela=None, factor=1, **argsll
    ):
        coords = {EJE_PARC: None, EJE_DEST: parcela}
        return super().de_cuadro(
            datos_pd,
            corresp=corresp,
            coords=coords,
