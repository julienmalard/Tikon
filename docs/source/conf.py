...
# -*- coding: utf-8 -*-
#
# Tiko'n documentation build configuration file, created by
...
# of the sidebar.
#
html_logo = '_estático/Logo_Tikon.png'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#
html_favicon = '_estático/Logo_favicon.ico'
