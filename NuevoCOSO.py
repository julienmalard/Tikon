...
def prep_json(d):
    ...
    for ll, v in d.items():
        ...
        if type(v) is dict:
            ...
            # Si el itema era una matriz numpy, convertir la matriz al formato de lista, al menos que sea una
            # distribución a priori especificada por el usuario para una calibración, en cual caso la quitamos.
            if ll == 'especificado':
                d.pop(ll)
            else:
                d[ll] = v.tolist()
