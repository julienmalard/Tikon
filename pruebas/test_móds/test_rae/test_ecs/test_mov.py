...
from tikon.móds.rae.orgs.insectos import MetamCompleta, LotkaVolterra
...
exper = Exper(
    ...
    [
        Parcela("parc"),
        Parcela("parc 2", geom=GeomParcela(centroide=(11.0025001, 76.9656001))),
    ],
)
        ...
        for ec in Atracción.cls_ramas:
            with símismo.subTest(ec.nombre):
                ...
                mod = gen_modelo_reqs_clima(
                    ec, exper=exper, módulos=RedAE(insecto), t=t
                )
