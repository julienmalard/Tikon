...
class PruebaVarsInterés(unittest.TestCase):
    ...
    def test_obs(símismo):
        ...
        símismo._verif_excluido(
            ["módulo 1.res 1_2", "módulo 2.res 2_1", "módulo 2.res 2_2"], res
        )
    ...
    def test_nombres(símismo):
        ...
        símismo._verif_excluido(
            ["módulo 1.res 1_1", "módulo 1.res 1_2", "módulo 2.res 2_1"], res
        )
    ...
    def test_mixto(símismo):
        res = modelo.simular(
            "todos", exper, t=2, vars_interés=["módulo 2", "módulo 1.res 1_1"]
        )

        símismo._verif_incluido(
            ["módulo 1.res 1_1", "módulo 2.res 2_1", "módulo 2.res 2_2"], res
        )
