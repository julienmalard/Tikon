...
class Variedad(Coso):
    def __init__(símismo, **kwargs):
        ...
        símismo.dic_base = dict(Nombre="", Día_corto_crít=(), Pend_desarroll_fotoper=(), Tiempo_emerg_flor=(),
                                ...
                                Frac_prot_sem=(), Frac_aceit_sem=(), Grupo_matur=(), Indic_adapt_temp=(),
                                Taza_rep_min=(),
                                ...
                                Atraso_desarroll_foto=(), Tiempo_rep_mat=(), Máx_semill_por_planta=(),
                                Taza_opt_llen_sem=(), Interval_emerg_hojas=(), Temp_base=(), Temp_opt=(),
                                Temp_opt_rep=(),
