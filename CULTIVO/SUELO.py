...
class Suelo(Coso):
    def __init__(símismo, nombre, directorio):
        ...
        símismo.dic_base = dict(Nombre=nombre, Textura_suelo="", Profundidad_suelo=(), Color="", Albedo=(), Límite_evap=(),
        ...
        super().__init__(ext='su', nombre=nombre, directorio=directorio)  # Esta variable se initializa como Coso
