...
class Suelo(Coso):
    def __init__(self, *args, **kwargs):
        ...
        self.dic_base = dict(Textura_suelo="", Profundidad_suelo=(), Color="", Albedo=(), Límite_evap=(), Drenaje=(),
        ...
        self.ext = "su"  # La extensión para este tipo de documento. (Para guadar y cargar datos.)
